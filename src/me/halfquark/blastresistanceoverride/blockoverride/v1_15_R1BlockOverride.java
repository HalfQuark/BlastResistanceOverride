...
public class v1_15_R1BlockOverride extends BlockOverride {
    ...
    private Class<?> CraftMagicNumbers = Class.forName("org.bukkit.craftbukkit.v1_15_R1.util.CraftMagicNumbers");

    public v1_15_R1BlockOverride(Material material) throws ClassNotFoundException, NoSuchMethodException, InvocationTargetException, IllegalAccessException {
